...
app.get("/users", async (req: Request, res: Response) => {
  try {
    ...
    // prática 2 - utilizar o modelo implementado de User
    // pega as informações do usersDb (que veio direto do banco de dados) através no map e passa pelo objeto Users (que está preparado para o front)
...
app.post("/users", async (req: Request, res: Response) => {
  try {
    ...
    // agora a API será responsável por criar as datas para facilitar o instanciamento de User
